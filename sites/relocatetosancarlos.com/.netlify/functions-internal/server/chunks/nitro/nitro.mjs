...
const setHeader$1 = setResponseHeader$1;
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "0eb2cc64-b6e3-4dbc-9312-b9f818696700",
  ...
  "public": {
    "pocketbaseUrl": "https://api.sancarlosinsider.com/",
    "whatsappNumber": "6444444444",
    "siteName": "RelocateToSanCarlos.com",
    "siteUrl": "https://www.relocatetosancarlos.com",
    "twitterSite": "@relocatetosc",
    "blogType": "relocateBlog",
    "chatgptProxyUrl": "https://chatgpt-proxy.guillermoantoniomedel.workers.dev"
  },
  "sitemap": {
    "isI18nMapped": false,
  ...
  "nuxt-robots": {
    ...
    "sitemap": [
      "https://relocatetosancarlos.com/sitemap.xml",
      "/sitemap.xml"
    ],
    "header": true,
...
const _syVQuktDXEiVv0iErp03bYbeiJjivct1GFlTcvRKb4 = defineNitroPlugin(async (nitroApp) => {
...
const _xFzmTG0TvLmH2uYmVYVAgUoklbA5x55XUqYWrGvEUqk = defineNitroPlugin(async (nitroApp) => {
...
const _Fl1WARzVQTl4JvrQybwXYyr3vaiKoeMtsHqtoIK3Tw = (function(nitro) {
...
const plugins = [
  _syVQuktDXEiVv0iErp03bYbeiJjivct1GFlTcvRKb4,
_xFzmTG0TvLmH2uYmVYVAgUoklbA5x55XUqYWrGvEUqk,
_Fl1WARzVQTl4JvrQybwXYyr3vaiKoeMtsHqtoIK3Tw
];
...
const _pey5Ke = eventHandler(async (e) => {
...
function fixSlashes(trailingSlash, pathOrUrl) {
  ...
  if (isPathFile($url.pathname))
    return pathOrUrl;
  const fixedPath = trailingSlash ? withTrailingSlash($url.pathname) : withoutTrailingSlash$1($url.pathname);
...
const _iJCZXc = defineEventHandler$1(async (e) => {
...
const _gkkiDA = defineEventHandler$1(async (e) => {
...
const _F9Clz6 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _dw_sZn = defineEventHandler(async (e) => {
...
const _W8srCj = lazyEventHandler(() => {
...
const _lazy_jk9wXF = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_jk9wXF, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _pey5Ke, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _iJCZXc, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _gkkiDA, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _F9Clz6, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _dw_sZn, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _W8srCj, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_jk9wXF, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, handler as A, getResponseStatus as a, buildAssetsURL as b, getQuery$2 as c, defineRenderHandler as d, createError$1 as e, getRouteRules as f, getResponseStatusText as g, hasProtocol$1 as h, useNitroApp as i, joinURL as j, isScriptProtocol as k, getContext as l, baseURL as m, createHooks as n, executeAsync as o, publicAssetsURL as p, createRouter$2 as q, relative as r, sanitizeStatusCode as s, toRouteMatcher$1 as t, useRuntimeConfig as u, defu$1 as v, withQuery as w, parseQuery$1 as x, withTrailingSlash as y, withoutTrailingSlash$1 as z };
