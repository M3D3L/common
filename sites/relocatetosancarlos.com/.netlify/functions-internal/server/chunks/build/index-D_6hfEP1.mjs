import { defineComponent, h, ref, useAttrs, getCurrentInstance, Comment, mergeProps, cloneVNode, computed, inject, provide, watch } from 'vue';
import { invariant as invariant$1 } from 'hey-listen';
import { i as isDef } from './index-C2tg38pJ.mjs';
...
class MotionState {
  ...
  initTarget(initialVariantSource) {
    var _a2;
    var _a;
    const custom = (_a2 = this.options.custom) != null ? _a2 : (_a = this.options.animatePresenceContext) == null ? void 0 : _a.custom;
...
class NativeAnimationExtended extends NativeAnimation {
  ...
  updateMotionValue(value) {
    ...
    const sampleTime = /* @__PURE__ */ secondsToMilliseconds((_a = this.finishedTime) != null ? _a : this.time);
...
class AnimationFeature extends Feature {
  ...
  createAnimationFactories(prevTarget, animationOptions, controlDelay) {
    ...
    Object.keys(this.state.target).forEach((key) => {
      ...
      if (!hasChanged(prevTarget[key], this.state.target[key]))
        return;
      (_a2 = (_a = this.state.baseTarget)[key]) != null ? _a2 : _a[key] = style.get(this.state.element, key);
  ...
  resolveStateAnimation({
    ...
    const customValue = custom != null ? custom : animatePresenceContext == null ? void 0 : animatePresenceContext.custom;
...
function useMotionState(props) {
  ...
  function getProps() {
    ...
    return {
      ...
      transition: (_a2 = props.transition) != null ? _a2 : config.value.transition,
      layoutGroup,
      motionConfig: config.value,
      inViewOptions: (_b = props.inViewOptions) != null ? _b : config.value.inViewOptions,
  ...
  function getAttrs() {
    ...
    if (isSVG) {
      ...
      if (style22.transform || attrs2.transformOrigin) {
        style22.transformOrigin = (_a3 = attrs2.transformOrigin) != null ? _a3 : "50% 50%";
        delete attrs2.transformOrigin;
      }
      if (style22.transform) {
        style22.transformBox = (_b = style22.transformBox) != null ? _b : "fill-box";
...
export { motion as m };
//# sourceMappingURL=index-D_6hfEP1.mjs.map
