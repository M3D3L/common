...
import { x as parseQuery, h as hasProtocol, j as joinURL, y as withTrailingSlash, z as withoutTrailingSlash } from '../nitro/nitro.mjs';
import { d as useRouter, f as useNuxtApp$1, r as resolveRouteObject, b as useRuntimeConfig, n as navigateTo, i as nuxtLinkDefaults } from './server.mjs';
...
function defineNuxtLink(options) {
  ...
  return defineComponent({
    ...
    setup(props, { slots }) {
      ...
      const el = void 0;
      const elRef = void 0;
      async function prefetch(nuxtApp = useNuxtApp$1()) {
        {
          return;
        }
      }
...
//# sourceMappingURL=nuxt-link-8UYShezB.mjs.map
