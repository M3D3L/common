<template>
  <div class="w-full">
    ...
    <div class="flex flex-col items-center justify-center w-full min-h-screen py-16">
      ...
      <SectionsProjects v-if="recentProjects?.items?.length" :title="recentProjects?.title" :description="recentProjects?.description" :items="recentProjects?.items" />
    </div>
...
const { heroSection, skillsSection, recentProjects, seoDefaults } = layoutConfig;
