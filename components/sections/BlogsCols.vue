<template>
    <section id="blogs" class="relative z-10 flex flex-col px-6 py-24 md:px-0" ref="heroRef"
        :class="{ 'bg-cover bg-center': !isVideoComponentActive }" :style="{
        ...
        <div class="relative md:container flex-flex-col">
            <TextSectionTitle :title :description :imgSrc="BlockMe5" />
            <div class="flex flex-col w-full min-h-screen gap-8 pb-16 mt-12 lg:pb-24 lg:flex-row">
...
// Calculate reading time - This part is unrelated to the video component.
